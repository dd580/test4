...
function playGame(user_choice) {
  ...
  let user_choice_image = `<image src="images/${user_choice}.png" width=70 height=70>`;
  ...
  let computer_choice_image = `<image src="images/${computer_choice}.png" width=70 height=70>`;
